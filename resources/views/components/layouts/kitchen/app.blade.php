...
<head>
    ...
    <title>@yield('meta_title',        'Kitchen Dashboard | Hubwale')</title>
    <meta name="description" content="@yield('meta_description', 'Hubwale Kitchen panel')">
    <meta name="keywords" content="@yield('meta_keywords', '')">

    <link rel="icon" type="image/png" href="{{ asset($siteSettings->icon ?? 'icon/hubwalelogopng.png') }}">
    <meta name="csrf-token" content="{{ csrf_token() }}">

    <title>{{ $siteSettings->meta_title ?? 'Kitchen Dashboard | Hubwale' }}</title>
...
<body class="bg-gray-50 text-gray-800">
    ...
    @include('components.layouts.resturant.footer')
    ...
    <script>
        ...
        document.querySelector('meta[name="description"]').setAttribute('content', "{{ $siteSettings->meta_description ?? 'Hubwale kitchen panel' }}");
