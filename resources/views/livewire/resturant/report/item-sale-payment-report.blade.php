<div class="p-4 max-w-7xl mx-auto">
    <h2 class="text-2xl font-bold mb-4">Item Sale Payment Report</h2>
    ...
    <div class="flex flex-col sm:flex-row sm:space-x-4 space-y-2 sm:space-y-0 mb-4">
        ...
        <select wire:model.live="category_id" class="border p-2 rounded">
    ...
    <div class="bg-white border border-blue-500 rounded-md shadow p-4 mb-4 w-full max-w-xl mx-auto text-center">
        ...
        <p><strong>Total Quantity:</strong> {{ $data->sum('total_qty') }}</p>
        <p><strong>Total Sale Amount:</strong> ₹{{ number_format($data->sum('total_amount'), 2) }}</p>
    </div>
    ...
    <div class="overflow-x-auto">
        <table class="min-w-full divide-y divide-gray-200 border border-gray-300">
            <thead class="bg-orange-400 text-black text-center">
                <tr>
                    <th class="px-4 py-2 text-sm font-semibold whitespace-nowrap">Sr</th>
                    ...
                    <th class="px-4 py-2 text-sm font-semibold whitespace-nowrap">Total Qty</th>
                    <th class="px-4 py-2 text-sm font-semibold whitespace-nowrap">Total Amt</th>
                </tr>
            </thead>
