        ...
        <div class="flex flex-col gap-3 md:gap-4">
            <div class="flex items-center justify-between min-w-0">
                ...
                <div class="shrink-0 md:ml-4 flex flex-row gap-3">
                    @can('table-create')
                        <x-form.button title="+ Add" route="restaurant.tables.create"
                            ...
                            <div class="flex items-center justify-start space-x-2">
                                ...
                                @can('table-show')
                                    <x-form.button title="" class="w-8 h-8 rounded flex items-center justify-center"
                                        :route="['restaurant.tables.show', $table->id]">
                                ...
                                @can('table-edit')
                                    <x-form.button title="" class="w-8 h-8 rounded flex items-center justify-center"
                                        :route="['restaurant.tables.edit', $table->id]">
                                        <span class="w-4 h-4">
        ...
        @if ($confirmingDelete)
            <div class="fixed inset-0 bg-transparent bg-opacity-0 z-40 flex items-center justify-center">
                <div class="bg-white rounded-lg p-6 shadow-xl z-50 w-full max-w-md">
                    ...
                    <p class="text-gray-700 mb-6">Are you sure you want to delete this table? This action cannot
                        be
                        undone.</p>
