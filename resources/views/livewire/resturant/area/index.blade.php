<div class="p-6 bg-white rounded shadow">
    ...
    <div class="flex justify-between items-center mb-4">
        <h2 class="text-xl font-bold">Area List</h2>
         <div class="flex items-center gap-4">
            <x-form.input
                ...
                inputClass="w-72"    
            />
            <x-form.button title="+ Add" route="restaurant.areas.create" class="bg-blue-600 hover:bg-blue-700 text-white" />
        </div>
    </div>
    <x-form.error />
        ...
        @if ($confirmingDelete)
            <div class="fixed inset-0 bg-transparent bg-opacity-0 z-40 flex items-center justify-center">
                <div class="bg-white rounded-lg p-6 shadow-xl z-50 w-full max-w-md">
                    ...
                    <p class="text-gray-700 mb-6">Are you sure you want to delete this area? This action cannot be
                        undone.</p>
