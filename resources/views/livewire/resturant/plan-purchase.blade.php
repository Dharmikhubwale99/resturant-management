                ...
                <div class="flex items-center justify-between mt-4">
                    <div>
                        @if ($finalPrice < $originalPrice)
                            <div>
                                <span class="text-sm line-through text-red-400">₹{{ number_format($originalPrice, 2) }}</span>
                                <span class="text-lg font-bold text-green-600 ml-2">₹{{ number_format($finalPrice, 2) }}</span>
                            </div>
                        @else
                            <span class="text-lg font-bold text-gray-800">₹{{ number_format($finalPrice, 2) }}</span>
                        @endif
                    </div>
