<div class="max-w-6xl mx-auto px-4 py-8">
    <h2 class="text-2xl font-bold mb-6">Edit Restaurant & User</h2>
    <x-form.error />
    ...
    <form wire:submit.prevent="update" class="space-y-8">
        ...
        <div class="rounded-lg p-6 shadow">
            ...
            <x-form.input name="restaurant_address" label="Address" type="textarea"
                          wireModel="restaurant_address" class="md:col-span-2" />
        </div>

        <div class="rounded-lg p-6 shadow">
            <h3 class="text-lg font-semibold text-gray-700 mb-4 border-b">Meta Settings</h3>
            ...
            @if ($oldFavicon)
                <div class="mt-4">
                    ...
                    <img src="{{ asset('storage/' . $oldFavicon) }}" class="w-16 h-16 rounded" alt="Current Favicon">
                </div>
            @endif
        </div>

        <div class="rounded-lg p-6 shadow">
            <h3 class="text-lg font-semibold text-gray-700 mb-4 border-b">Subscription</h3>
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
